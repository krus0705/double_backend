...
public class ParamPasswordResetUpdateBody {

    private PasswordUpdateModel passwordResetUpdateBody;

    public ParamPasswordResetUpdateBody(final PasswordUpdateModel passwordResetUpdateBody) {
        this.passwordResetUpdateBody = passwordResetUpdateBody;
    }

    public PasswordUpdateModel getPasswordResetUpdateBody() {
        return this.passwordResetUpdateBody;
    }
