...
public class ParamGetProductPage {

    private String productShareCode;

    public ParamGetProductPage(final String productShareCode) {
        this.productShareCode = productShareCode;
    }

    public String getProductShareCode() {
