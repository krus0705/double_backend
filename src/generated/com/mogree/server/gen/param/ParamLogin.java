...
public class ParamLogin {
    ...
    private String mogreeMail;
    private String mogreePassword;

    public ParamLogin(final String mogreeMail, final String mogreePassword) {
        this.mogreeMail = mogreeMail;
        this.mogreePassword = mogreePassword;
    }

    public String getMogreeMail() {
        return this.mogreeMail;
    }
