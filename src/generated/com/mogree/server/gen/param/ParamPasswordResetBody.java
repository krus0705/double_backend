...
public class ParamPasswordResetBody {

    private PasswordResetModel resetPasswordBody;

    public ParamPasswordResetBody(final PasswordResetModel resetPasswordBody) {
        this.resetPasswordBody = resetPasswordBody;
    }

    public PasswordResetModel getResetPasswordBody() {
